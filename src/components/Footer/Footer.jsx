      ...
      <footer className="p-10 bg-slate-200 mt-28">
        <div className="footer max-w-6xl mx-auto flex flex-wrap justify-between ">
          <nav>
            ...
            <a href="mailto:aurora@articraft.com" className="link link-hover">
              Email: aurora@articraft.com
            </a>
            <a href="callto:9876543210" className="link link-hover">
              Call: 9876543210
            </a>
            <a className="link link-hover">Address: Tampere, Finland</a>
          </nav>
          <nav>
